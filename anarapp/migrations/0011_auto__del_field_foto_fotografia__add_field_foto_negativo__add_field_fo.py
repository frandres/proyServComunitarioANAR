...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Foto.fotografia'
        db.delete_column('anarapp_foto', 'fotografia')

        # Adding field 'Foto.negativo'
        db.add_column('anarapp_foto', 'negativo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Adding field 'Foto.numFoto'
        db.add_column('anarapp_foto', 'numFoto',
    ...
    def backwards(self, orm):
        # Adding field 'Foto.fotografia'
        db.add_column('anarapp_foto', 'fotografia',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Deleting field 'Foto.negativo'
        db.delete_column('anarapp_foto', 'negativo')

        # Deleting field 'Foto.numFoto'
        db.delete_column('anarapp_foto', 'numFoto')


        # Changing field 'Foto.numMarcaNegativo'
        db.alter_column('anarapp_foto', 'numMarcaNegativo', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Foto.institucion'
        db.alter_column('anarapp_foto', 'institucion', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Foto.numReferencia'
        db.alter_column('anarapp_foto', 'numReferencia', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Foto.fotografo'
        db.alter_column('anarapp_foto', 'fotografo', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Foto.numRollo'
        db.alter_column('anarapp_foto', 'numRollo', self.gf('django.db.models.fields.IntegerField')())
