...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CaraTrabajada.alto'
        db.alter_column('anarapp_caratrabajada', 'alto', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))

        # Changing field 'CaraTrabajada.ancho'
        db.alter_column('anarapp_caratrabajada', 'ancho', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))

        # Changing field 'CaraTrabajada.largo'
        db.alter_column('anarapp_caratrabajada', 'largo', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))

        # Changing field 'CaraTrabajada.altura'
        db.alter_column('anarapp_caratrabajada', 'altura', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CaraTrabajada.alto'
        db.alter_column('anarapp_caratrabajada', 'alto', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

        # Changing field 'CaraTrabajada.ancho'
        db.alter_column('anarapp_caratrabajada', 'ancho', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

        # Changing field 'CaraTrabajada.largo'
        db.alter_column('anarapp_caratrabajada', 'largo', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

        # Changing field 'CaraTrabajada.altura'
        db.alter_column('anarapp_caratrabajada', 'altura', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))
