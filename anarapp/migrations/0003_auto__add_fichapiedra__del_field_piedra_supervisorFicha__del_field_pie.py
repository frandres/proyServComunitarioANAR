...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FichaPiedra'
        db.create_table('anarapp_fichapiedra', (
            ...
            ('fechaLlenado', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('supervisor', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('fechaSupervision', self.gf('django.db.models.fields.DateField')(blank=True)),
        ))
        db.send_create_signal('anarapp', ['FichaPiedra'])

        # Deleting field 'Piedra.supervisorFicha'
        db.delete_column('anarapp_piedra', 'supervisorFicha')

        # Deleting field 'Piedra.fechaSupervisionFicha'
        db.delete_column('anarapp_piedra', 'fechaSupervisionFicha')

        # Deleting field 'Piedra.fechaEscrituraFicha'
        db.delete_column('anarapp_piedra', 'fechaEscrituraFicha')

        # Deleting field 'Piedra.revisoFicha'
        db.delete_column('anarapp_piedra', 'revisoFicha')

        # Deleting field 'Piedra.autorFicha'
        db.delete_column('anarapp_piedra', 'autorFicha')


    def backwards(self, orm):
        # Deleting model 'FichaPiedra'
        db.delete_table('anarapp_fichapiedra')

        # Adding field 'Piedra.supervisorFicha'
        db.add_column('anarapp_piedra', 'supervisorFicha',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Adding field 'Piedra.fechaSupervisionFicha'
        db.add_column('anarapp_piedra', 'fechaSupervisionFicha',
                      self.gf('django.db.models.fields.DateField')(default=''),
                      keep_default=False)

        # Adding field 'Piedra.fechaEscrituraFicha'
        db.add_column('anarapp_piedra', 'fechaEscrituraFicha',
                      self.gf('django.db.models.fields.DateField')(default=''),
                      keep_default=False)

        # Adding field 'Piedra.revisoFicha'
        db.add_column('anarapp_piedra', 'revisoFicha',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Adding field 'Piedra.autorFicha'
        db.add_column('anarapp_piedra', 'autorFicha',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)
