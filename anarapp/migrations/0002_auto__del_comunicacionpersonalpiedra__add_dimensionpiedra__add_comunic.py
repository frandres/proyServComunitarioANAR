...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anarapp_dimensionpiedra', (
            ...
            ('altoMaximo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6)),
            ('largoMaximo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6)),
            ('anchoMaximo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6)),
        ))
        ...
        # Deleting field 'Piedra.largoMaximo'
        db.delete_column('anarapp_piedra', 'largoMaximo')

        # Deleting field 'Piedra.anchoMaximo'
        db.delete_column('anarapp_piedra', 'anchoMaximo')

        # Deleting field 'Piedra.altoMaximo'
        db.delete_column('anarapp_piedra', 'altoMaximo')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Piedra.largoMaximo'
        db.add_column('anarapp_piedra', 'largoMaximo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'Piedra.anchoMaximo'
        db.add_column('anarapp_piedra', 'anchoMaximo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'Piedra.altoMaximo'
        db.add_column('anarapp_piedra', 'altoMaximo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)
    ...
    models = {
        ...
        'anarapp.dimensionpiedra': {
            ...
            'altoMaximo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '6'}),
            'anchoMaximo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '6'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'largoMaximo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '6'}),
            'piedra': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anarapp.Piedra']"})
        },
        'anarapp.dolmen': {
