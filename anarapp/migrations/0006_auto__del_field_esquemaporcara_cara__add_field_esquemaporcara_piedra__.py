...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EsquemaPorCara.cara'
        db.delete_column('anarapp_esquemaporcara', 'cara_id')

        # Adding field 'EsquemaPorCara.piedra'
        db.add_column('anarapp_esquemaporcara', 'piedra',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['anarapp.Piedra']),
                      keep_default=False)

        # Adding field 'EsquemaPorCara.numero'
        db.add_column('anarapp_esquemaporcara', 'numero',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ConjFiguraPorTipo.cara'
        db.delete_column('anarapp_conjfiguraportipo', 'cara_id')

        # Adding field 'ConjFiguraPorTipo.piedra'
        db.add_column('anarapp_conjfiguraportipo', 'piedra',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['anarapp.Piedra']),
                      keep_default=False)

        # Adding field 'ConjFiguraPorTipo.numero'
        db.add_column('anarapp_conjfiguraportipo', 'numero',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EsquemaPorCara.cara'
        db.add_column('anarapp_esquemaporcara', 'cara',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['anarapp.CaraTrabajada']),
                      keep_default=False)

        # Deleting field 'EsquemaPorCara.piedra'
        db.delete_column('anarapp_esquemaporcara', 'piedra_id')

        # Deleting field 'EsquemaPorCara.numero'
        db.delete_column('anarapp_esquemaporcara', 'numero')

        # Adding field 'ConjFiguraPorTipo.cara'
        db.add_column('anarapp_conjfiguraportipo', 'cara',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['anarapp.CaraTrabajada']),
                      keep_default=False)

        # Deleting field 'ConjFiguraPorTipo.piedra'
        db.delete_column('anarapp_conjfiguraportipo', 'piedra_id')

        # Deleting field 'ConjFiguraPorTipo.numero'
        db.delete_column('anarapp_conjfiguraportipo', 'numero')
