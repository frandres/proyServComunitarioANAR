...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BibliografiaPiedra'
        db.create_table('anarapp_bibliografiapiedra', (
        ...
        db.send_create_signal('anarapp', ['BibliografiaPiedra'])


    def backwards(self, orm):
        # Deleting model 'BibliografiaPiedra'
        db.delete_table('anarapp_bibliografiapiedra')
