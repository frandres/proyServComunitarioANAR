...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ObtInfoPiedra.id'
        db.delete_column('anarapp_obtinfopiedra', 'id')

        # Adding field 'ObtInfoPiedra.obtencioninfo_ptr'
        db.add_column('anarapp_obtinfopiedra', 'obtencioninfo_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['anarapp.ObtencionInfo'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ObtInfoPiedra.id'
        db.add_column('anarapp_obtinfopiedra', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Deleting field 'ObtInfoPiedra.obtencioninfo_ptr'
        db.delete_column('anarapp_obtinfopiedra', 'obtencioninfo_ptr_id')
    ...
    models = {
        ...
        'anarapp.obtencioninfo': {
            ...
            'direccionEmail': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
