...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UbicacionCarasTrabajadas.tieneLuminosidad'
        db.delete_column('anarapp_ubicacioncarastrabajadas', 'tieneLuminosidad')


    def backwards(self, orm):
        # Adding field 'UbicacionCarasTrabajadas.tieneLuminosidad'
        db.add_column('anarapp_ubicacioncarastrabajadas', 'tieneLuminosidad',
