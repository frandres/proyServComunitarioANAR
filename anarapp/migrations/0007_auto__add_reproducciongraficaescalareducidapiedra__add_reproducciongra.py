...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReproduccionGraficaEscalaReducidaPiedra'
        db.create_table('anarapp_reproducciongraficaescalareducidapiedra', (
        ...
        db.send_create_signal('anarapp', ['ReproduccionGraficaEscalaReducidaPiedra'])

        # Adding model 'ReproduccionGraficaEscalaNaturalPiedra'
        db.create_table('anarapp_reproducciongraficaescalanaturalpiedra', (
            ('reproducciongrafica_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['anarapp.ReproduccionGrafica'], unique=True, primary_key=True)),
            ('piedra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anarapp.Piedra'])),
            ('tipoReproduccion', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('anarapp', ['ReproduccionGraficaEscalaNaturalPiedra'])

        # Deleting field 'FotografiaPiedra.fotografia'
        db.delete_column('anarapp_fotografiapiedra', 'fotografia')


    def backwards(self, orm):
        # Deleting model 'ReproduccionGraficaEscalaReducidaPiedra'
        db.delete_table('anarapp_reproducciongraficaescalareducidapiedra')

        # Deleting model 'ReproduccionGraficaEscalaNaturalPiedra'
        db.delete_table('anarapp_reproducciongraficaescalanaturalpiedra')

        # Adding field 'FotografiaPiedra.fotografia'
        db.add_column('anarapp_fotografiapiedra', 'fotografia',
    ...
    models = {
        ...
        'anarapp.reproducciongraficaescalanaturalpiedra': {
            'Meta': {'object_name': 'ReproduccionGraficaEscalaNaturalPiedra', '_ormbases': ['anarapp.ReproduccionGrafica']},
            'piedra': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anarapp.Piedra']"}),
            'reproducciongrafica_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['anarapp.ReproduccionGrafica']", 'unique': 'True', 'primary_key': 'True'}),
            'tipoReproduccion': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        'anarapp.reproducciongraficaescalareducidapiedra': {
            'Meta': {'object_name': 'ReproduccionGraficaEscalaReducidaPiedra', '_ormbases': ['anarapp.ReproduccionGrafica']},
            'piedra': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anarapp.Piedra']"}),
            'reproducciongrafica_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['anarapp.ReproduccionGrafica']", 'unique': 'True', 'primary_key': 'True'}),
            'tipoReproduccion': ('django.db.models.fields.IntegerField', [], {})
        },
